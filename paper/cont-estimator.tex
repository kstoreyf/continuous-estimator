...
With current observations, the LSS is well-described by a cold dark matter model with a cosmological constant, the standard $\Lambda$CDM model \citep{Planck2018}.
...
The median estimate of the recovered scale dilation parameter is $\alpha=0.9975 \pm 0.0290$, where the uncertainty is the mean of the 16th and 84th percentile differences from the median; our estimate is very close to the true value of $\alpha = 0.9987$.
